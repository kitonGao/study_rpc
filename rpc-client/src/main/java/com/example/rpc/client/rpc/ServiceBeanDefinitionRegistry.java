...
public class ServiceBeanDefinitionRegistry implements BeanDefinitionRegistryPostProcessor, ResourceLoaderAware, ApplicationContextAware{
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        Set<Class<?>> classSet = scannerPackages("com.example.rpc.client.remoteservice");
        classSet.stream().filter(Class::isInterface).forEach(x -> registerBean(registry, x));
    }
